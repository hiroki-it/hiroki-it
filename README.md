...
その後、BtoC Web サービス企業に入社し、SWE としてドメイン駆動設計に取り組み、また同社で SRE として CI/CD・IaC・クラウドインフラ・オブザーバビリティーや SRE チーム拡大に貢献しました！

現在はフィンテックドメインで、Platform SWE や SRE（Embedded、Enabling、Platform）のテックリードを担っています！さまざまなマイクロサービスアーキテクチャに関わるサービスメッシュ・マイクロサービス・CI/CD・IaC・クラウドインフラ・オブザーバビリティー領域で、ステークホルダーとの組織横断的な合意形成や、ミッションクリティカル要件を満たす開発のリードに取り組んでいます！👊🔥
...
- クラウドインフラ（AWS、少し Google Cloud など）、少しオンプレ
